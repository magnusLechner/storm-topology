...
public class BooleanFeatureVectorGenerator extends FeatureVectorGenerator {
	private static final Logger LOG = LoggerFactory.getLogger(BooleanFeatureVectorGenerator.class);
	...
	public BooleanFeatureVectorGenerator() {
		m_vectorStartId = 1;
		LOG.info("VectorSize: " + VECTOR_SIZE);
	}

	public BooleanFeatureVectorGenerator(int vectorStartId) {
