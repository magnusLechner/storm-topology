...
public class NoPOSUndefinedTwitchFeatureVectorGenerator extends NoPOSFeatureVectorGenerator {
	private static final Logger LOG = LoggerFactory.getLogger(NoPOSUndefinedTwitchFeatureVectorGenerator.class);
	...
	public NoPOSUndefinedTwitchFeatureVectorGenerator(int vectorStartId) {
		this();
