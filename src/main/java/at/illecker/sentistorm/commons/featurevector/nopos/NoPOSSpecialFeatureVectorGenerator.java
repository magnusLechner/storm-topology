...
public class NoPOSSpecialFeatureVectorGenerator extends NoPOSFeatureVectorGenerator {
	private static final Logger LOG = LoggerFactory.getLogger(NoPOSSpecialFeatureVectorGenerator.class);
	...
	public NoPOSSpecialFeatureVectorGenerator() {
		m_vectorStartId = 1;
		LOG.info("VectorSize: " + getFeatureVectorSize());
	}

	public NoPOSSpecialFeatureVectorGenerator(int vectorStartId) {
