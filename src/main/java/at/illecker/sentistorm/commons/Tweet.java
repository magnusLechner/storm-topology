...
public class Tweet implements Serializable {
	...
	public static List<Tweet> getTestTweets() {
		...
		tweets.add(new Tweet(4L, "LOL nice try 4Head", 1.0));
		tweets.add(new Tweet(4L, "WutFace", 0.0));
		tweets.add(new Tweet(4L, "such a fa**ot DansGame", 0.0));
		return tweets;
	}
	
	public static List<Tweet> getSingleTestTweet() {
		List<Tweet> tweets = new ArrayList<Tweet>();
		tweets.add(new Tweet(4L, "LOL :D :( nice try :) 4Head WutFace wutface", 0.0));
		return tweets;
	}
