...
public class SentimentResult {
	...
	public void addScore(double score) {
		...
		} else if ((score >= SentimentResult.NEGATIVE_THRESHOLD) && (score <= SentimentResult.POSITIVE_THRESHOLD)) { // NEUTRAL
			this.m_neutralCount++;
		}
	}
	...
	public String toString() {
		return "SentimentResult [posCount=" + m_posCount + ", neutralCount=" + m_neutralCount + ", negCount="
				+ m_negCount + ", sum=" + m_sum + ", count=" + m_scores.size() + ", maxPos=" + m_maxPos + ", maxNeg="
