...
public class Dataset implements Serializable {
	...
	public Dataset(String datasetPath, String trainDataFile, String devDataFile, String testDataFile, String delimiter,
	...
	public List<Tweet> getTrainTweets(boolean includeDevTweets, boolean reload) {
		if (reload) {
			String serializationFile = getTrainDataSerializationFile();
			if (IOUtils.exists(serializationFile)) {
				LOG.info("Deserialize TrainTweets from: " + serializationFile);
				...
				//for smaug
//				m_trainTweets = FileUtils.readTweets("/home/stud/lechner/twitch-training.tsv", this);
			...
			return getTrainTweets(includeDevTweets);
		}
	}
	...
	public List<Tweet> getTestTweets(boolean reload) {
		if (reload) {
			// Try deserialization of file
			String serializationFile = getTestDataSerializationFile();
			if (IOUtils.exists(serializationFile)) {
				...
				LOG.info("Read TestTweets from: " + getTestDataFile());
				//for smaug
//				m_testTweets = FileUtils.readTweets("/home/stud/lechner/twitch-test.tsv", this);
	...
	public static Dataset readFromYaml(Map dataset) {
		...
		return new Dataset((String) dataset.get("path"), (String) dataset.get("train.file"),
