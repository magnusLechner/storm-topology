...
import at.storm.commons.dict.FirstNames;
import at.storm.commons.dict.PlayerNames;
import at.storm.commons.dict.SlangCorrection;
...
import at.storm.commons.wordnet.WordNet;
...
//			}
	...
	private String removeRepeatingChars(String value) {
		...
		while (m.find()) {
			...
			int end = m.end();
			// String c = m.group(1);
			// LOG.info("token: '" + value + "' match at start: " + start + "
			// end: "
			// + end);
			...
			if (!m_wordnet.contains(value)) {
				...
				for (int i = 0; i < end - start - 1; i++) {
					...
					// if the token is not in the vocabulary check all
					// combinations
					// of prior matches
	...
	public static void main(String[] args) {
		...
		// "suuuper suuper professional tell aahh aaahh aahhh aaahhh aaaahhhhh
		// gaaahh gaaahhhaaag haaahaaa hhhaaaahhhaaa"));
		// tweets.add(new Tweet(0L, "Martin martin kevin Kevin Justin justin"));
		// tweets.add(new Tweet(0L, "10,000 1000 +111 -111,0000.4444"));
		// tweets.add(new Tweet(0L, "bankruptcy\ud83d\ude05 happy:-) said:-)
		// ;-)yeah"));
		// tweets.add(new Tweet(0L, "I\u2019m shit\u002c fan\\u002c \\u2019t"));
		// tweets.add(new Tweet(0L,
		// "like...and vegas.just hosp.now lies\u002c1st lies,1st
		// candy....wasn\u2019t Nevada\u002cFlorida\u002cOhio\u002cTuesday
		// lol.,.lol lol...lol.."));
		// tweets.add(new Tweet(0L, "L.O.V.E D.R.U.G.S K.R.I.T"));
		// tweets.add(new Tweet(0L, "Lamar.....I free..edom free.edom
		// star.Kisses,Star Yes..a Oh,I it!!!Go Jenks/sagna"));
		// tweets.add(new Tweet(0L,
		// "32.50 $3.25 49.3% 97.1FM 97.1fm 8.30pm 12.45am 12.45AM 12.45PM 6-7pm
		// 5-8p 6pm-9pm @9.15 tonight... 10,000 199,400 149,597,900 20,000+
		// 10.45,9 8/11/12"));
